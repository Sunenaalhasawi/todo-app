...
const getList=async ()=>{
    try{
        ...
        lists.forEach((el,index)=>{
            listcontent+=`<li class="list-group-item  ${index%2?'list-group-item-info':'list-group-item-success'}"> <input type="checkbox" class="checkbox" /> <label for=""> ${el.title}</label></li>`
        });
